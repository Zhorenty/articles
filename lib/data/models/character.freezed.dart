...
abstract class $InfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int count, int pages, String? nextPage, String? prev});
}
...
class _$_Info implements _Info {
  const _$_Info(
      {required this.count, required this.pages, this.nextPage, this.prev});
  ...
  @override
  String toString() {
    return 'Info(count: $count, pages: $pages, nextPage: $nextPage, prev: $prev)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, count, pages, nextPage, prev);
